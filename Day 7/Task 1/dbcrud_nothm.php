...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if( $qry =  mysqli_query($con,"INSERT INTO `tbl_studnt`(`std_name`, `std_email`, `std_gender`, `std_pass`, `std_cont`, `std_add`, `std_pin`, `std_age`, `std_dob`, `std_blood`, `fath_name`, `moth_name`) VALUES ('$std_name','$std_email','$std_gen','$std_pass','$cont','$std_add','$std_pin','$std_age','$std_dob','$std_blood','$p_name','$m_name')")){
            echo "<script>alert('Record has been inserted');</script>";
        }
        else{
            echo "<script>alert('ERROR');window.location='dbcrud_nothm.php';</script>";
        }
    ...
    <section class="Form my-5 mx-5">
        <div class="container">
                ...
                <div class="col-lg-6 col-md-6 py-5 px-4 ">
                    ...
                    <form action="detail.php" class="ml-4" method="post">
